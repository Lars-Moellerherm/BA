...
rel_error_encaps = np.abs((truth_encaps-predictions_encaps)/truth_encaps)
...
perc_encaps, bins_p_encaps, binnumber_p_encaps = stats.binned_statistic(truth_encaps,rel_error_encaps,statistic=percentilesigma,bins=bin_edge)
...
mean_encaps, bins_m_encaps, binnumber_m_encaps = stats.binned_statistic(truth_encaps,rel_error_encaps,statistic='mean',bins=bin_edge)
