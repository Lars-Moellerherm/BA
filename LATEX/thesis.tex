...
\title{Verbesserung der Energie Regression bei CTA}
\date{2018}
\birthplace{Mettingen}
\chair{Lehrstuhl für Experimentelle Physik Vb}
\division{Fakultät Physik}
\thesisclass{Bachelor of Science}
\submissiondate{15. September 2018}
\firstcorrector{Prof.~Dr.~Rhode}
...
\input{content/02_theoretische_grundlage.tex}
\input{content/03_ergebnisse.tex}
\input{content/04_zusammenfassung_und_ausblick.tex}
\input{content/05_Danksagung.tex}
